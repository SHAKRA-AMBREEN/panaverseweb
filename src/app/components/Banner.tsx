            ...
            >
              ...
              >
                ...
                <Text pr="50px" pt="20px">
                  {" "}
                  The curriculum is intended for beginners who want to learn
                  software development from the groung up. It is going to be a
                  fourteen-month long hybrid program that includes both onsite
                  and online classes and is divided into fie quarters of 13
                  weeks each. The emphasis will be on hands-on learning by
                  educating students to produce projects{" "}
                </Text>
                <Button size="lg" colorScheme="teal" mt="10px" mb="40px">
                  {" "}
                  Read More{" "}
                </Button>
              </RevealWrapper>
